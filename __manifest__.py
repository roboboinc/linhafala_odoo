{
    ...
    'data': [
        ...
        'data/linhafala.caso.categoria_juridica.csv',
        'data/linhafala.caso.area.csv',
        'data/linhafala.caso.enquadramento.csv',
        'data/linhafala.caso.subcategoria_auto.csv',
        'data/linhafala.caso.classificacao.csv',
        'data/linhafala.caso.tipo.csv',
